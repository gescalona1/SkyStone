...
abstract class CmnFastMath {
    ...
    static final boolean FM_USE_JDK_MATH = getBooleanProperty("net.jafama.usejdk", false);

    /**
     * Used for both FastMath.log(double) and FastMath.log10(double).
     */
    static final boolean FM_USE_REDEFINED_LOG = getBooleanProperty("net.jafama.fastlog", false);

    static final boolean FM_USE_REDEFINED_SQRT = getBooleanProperty("net.jafama.fastsqrt", false);
    ...
    static final boolean SFM_USE_JDK_MATH = getBooleanProperty("net.jafama.strict.usejdk", false);
     ...
     */
    static final boolean SFM_USE_REDEFINED_LOG = getBooleanProperty("net.jafama.strict.fastlog", true);

    static final boolean SFM_USE_REDEFINED_SQRT = getBooleanProperty("net.jafama.strict.fastsqrt", false);
